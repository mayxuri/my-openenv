...
class CustomerSupportEnv:
    ...
    def step(self, action: Action) -> Tuple[Observation, float, bool, Dict[str, Any]]:
        ...
        if action_type == "ask_clarification":
            reward = 0.0
            feedback = (
                "Clarification: Use your best judgement based on the ticket content provided. "
                "The ticket information is complete."
            )
            ...
            if self.task_name == "classify":
                ...
                raw_reward, info = grade_respond(
                    action_dict, self._current_answer, self._ticket_raw
                )
            else:
                raw_reward = 0.0
        ...
        # Force episode end if max steps exhausted
